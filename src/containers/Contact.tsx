...
const Contact: FC = () => {
  const socials = [
    ...
    {
      href: 'https://github.com/JusticeMatthew/t3portfolio',
  ...
  return (
    ...
    >
      ...
      <div className="flex h-3/4 flex-col items-center justify-center gap-12 px-10 md:h-[90%] md:w-container md:flex-row md:justify-between lg:px-16">
        <ContactForm />
        <div
          id="socials"
          className="z-10 flex h-40 w-auto flex-row gap-2 md:-mt-9 md:h-72 md:flex-col"
        >
